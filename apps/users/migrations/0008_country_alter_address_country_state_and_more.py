...
import apps.users.utils.default_country
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='address',
            name='country',
            field=models.ForeignKey(default=apps.users.utils.default_country.get_default_country, on_delete=django.db.models.deletion.PROTECT, to='users.country'),
        ),
        migrations.CreateModel(
            name='State',
            fields=[
